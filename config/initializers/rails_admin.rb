# RailsAdmin config file. Generated on September 11, 2012 19:02
...
RailsAdmin.config do |config|
  ...
  config.included_models = [App, AppScript, Resource, User]
  ...
  #   update do; end
  # end
  # config.model Resources do
  #   # Found associations:
  #     configure :app, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
  #     configure :app_id, :integer         # Hidden 
  #     configure :resource_type, :integer 
  #     configure :resource_url, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
